...
-->
## Features
The newly developed 2.0 version features much more complex audio, video and display functionalities than its predecessor as well as the ability to export images. Speaking of display functionalities, let's look more in-depth at what the 2.0 version has grown capable of.
